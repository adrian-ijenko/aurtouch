...
export class Airtouch2PlusPlatform implements DynamicPlatformPlugin {
  ...
  private readonly acByName: Record<string, PlatformAccessory<Ctx>> = {};
  private readonly zoneByName: Record<string, PlatformAccessory<Ctx>> = {};
